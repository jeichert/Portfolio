  ...
  return (
    <IndexLayout css={HomePosts}>
      <Helmet>
        ...
        <meta
          property="og:image"
          content={`${config.siteUrl}${props.data.header.childImageSharp.fluid.src}`}/> {config.facebook && <meta property="article:publisher" content={config.facebook}/>}
        <meta name="archinect:card" content="summary_large_image"/>
        <meta name="archinect:title" content={config.title}/>
        <meta name="archinect:description" content={config.description}/>
        <meta name="archinect:url" content={config.siteUrl}/>
        <meta
          name="archinect:image"
          content={`${config.siteUrl}${props.data.header.childImageSharp.fluid.src}`}/> {config.archinect && (<meta
          name="archinect:site"
          content={`@${config
          .archinect
