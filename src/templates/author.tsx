...
import Archinect from '../components/icons/archinect';
  ...
  return (
    <IndexLayout>
      <Helmet>
        ...
        <meta name="archinect:card" content="summary"/>
        <meta name="archinect:title" content={`${author.id} - ${config.title}`}/>
              ...
              <AuthorMeta>
                ...
                {author.archinect && (
                  <a
                    ...
                    css={SocialLink}
                    href={`https://archinect.com/${author.archinect}`}
                    title="archinect"
                    target="_blank"
                    rel="noopener noreferrer">
                    <Archinect/>
